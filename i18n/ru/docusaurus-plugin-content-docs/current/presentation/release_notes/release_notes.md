...
- [x] Редактирование и удаление записей в дневниках
- [x] Очистка лога дневника
...
- [x] Преобразование графиков при переключении типа
...
- [ ] Скролл на многострочные поля ввода при нажатии на поле
