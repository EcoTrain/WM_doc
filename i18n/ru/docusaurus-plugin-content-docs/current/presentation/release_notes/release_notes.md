...
- [ ] (веб) Расширенный список форматов документов
- [ ] (веб) Расширенный список форматов изображений
  
QR:

- [ ] Ссылка на медикамент (и список медикаментов)
- [ ] Ссылка на одно событие в планировщике
