...
- [x] Подсказки в конструкторе дневника
...
- [ ] Редактирование и удаление записей в дневниках
- [ ] Пороги предупреждения в переменных и обозначение их на графиках дневников
- [ ] Переключение типа графика в окне просмотра дневника
- [ ] Подсказка с параметрами дневника на окне просмотра (параметры агрерирования, период и т.п.)
- [ ] Исправлены переводы EN текстов в конструкторе дневника
- [ ] Кнопки на модальных окнах привязаны к кнопкам на клавиатуре