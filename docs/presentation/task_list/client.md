...
- [ ] Настройки чата персональные
  ...
  - - [ ] Выйти из чата
- [ ] Учёт непрочитанных сообщений
  - - [ ] Last sync в БД (отсчёт кол-ва непрочитанных сообщений)
  - - [ ] Удаление уведомлений на устройствах после прочтения
...
- [ ] Отслеживание ошибок сервера
- [ ] Отслеживание отсутствие связи с сервером
- [ ] Уведомление пользователя об ошибке передачи данных
